...
if (!class_exists('Custom_WP_Bootstrap_Navwalker')) {
	 ...
	 */
	class Custom_WP_Bootstrap_Navwalker extends Walker_Nav_Menu
	{
		...
		public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
			...
			if ('' !== $linkmod_type) {
				...
				if ($depth == 1 && $args->has_children) {
					$item_output .= '<span class="nav-submenu-dropdown-button" data-toggle="dropdown"><i class="fa fa-chevron-down"></i></span><a' . $attributes . '>';
				} else {
